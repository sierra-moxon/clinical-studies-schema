# Contributing to clinical-studies-schema

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
clinical-studies-schema. These guidelines are not strict rules.
...
The clinical-studies-schema team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the clinical-studies-schema technical leads
...
[issues]: https://github.com/sierra-moxon/clinical-studies-schema/issues/
[pulls]: https://github.com/sierra-moxon/clinical-studies-schema/pulls/
