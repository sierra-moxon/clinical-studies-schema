...
LINKML_SCHEMA_NAME=clinical_studies_schema
LINKML_SCHEMA_AUTHOR=Sierra Moxon <smoxon@lbl.gov>
LINKML_SCHEMA_DESCRIPTION=sample schema that uextends CMDR using LinkML-map.
LINKML_SCHEMA_SOURCE_PATH=src/clinical_studies_schema/schema/clinical_studies_schema.yaml
