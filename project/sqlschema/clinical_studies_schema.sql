...
-- # Class: "Entity" Description: "Represents a Entity"
...
--     * Slot: name Description: A human-readable name for a thing
--     * Slot: description Description: A human-readable description for a thing
--     * Slot: EntityCollection_id Description: Autocreated FK slot
-- # Class: "EntityCollection" Description: "A holder for Entity objects"
--     * Slot: id Description: 
...
CREATE TABLE "Entity" (
	...
	name TEXT, 
	description TEXT, 
	"EntityCollection_id" INTEGER, 
	PRIMARY KEY (id), 
	FOREIGN KEY("EntityCollection_id") REFERENCES "EntityCollection" (id)
);